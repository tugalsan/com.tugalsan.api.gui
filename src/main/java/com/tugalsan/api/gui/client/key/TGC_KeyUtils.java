...
//    final private static TGC_Log d = TGC_Log.of(TGC_KeyUtils.class);
    ...
    public static void addEsc(TGS_CallableType0Void exe, FocusWidget... w) {
    ...
    public static void addCtrlEnter(TGS_CallableType0Void exe, FocusWidget... w) {
        TGS_ListUtils.of(w).forEach(wi -> wi.addKeyDownHandler(e -> {
    ...
    public static void addCtrlUp(TGS_CallableType0Void exe, FocusWidget... w) {
        TGS_ListUtils.of(w).forEach(wi -> wi.addKeyDownHandler(e -> {
    ...
    public static void addCtrlDown(TGS_CallableType0Void exe, FocusWidget... w) {
        TGS_ListUtils.of(w).forEach(wi -> wi.addKeyDownHandler(e -> {
    ...
    public static void addCtrlLeft(TGS_CallableType0Void exe, FocusWidget... w) {
        TGS_ListUtils.of(w).forEach(wi -> wi.addKeyDownHandler(e -> {
    ...
    public static void addCtrlRight(TGS_CallableType0Void exe, FocusWidget... w) {
        TGS_ListUtils.of(w).forEach(wi -> wi.addKeyDownHandler(e -> {
    ...
    public static void addDel(TGS_CallableType0Void exe, FocusWidget... w) {
        TGS_ListUtils.of(w).forEach(wi -> wi.addKeyDownHandler(e -> {
    ...
    public static void add(PushButton btn, TGS_CallableType0Void space, TGS_CallableType0Void esc) {
    ...
    public static void add(TextBox btn, TGS_CallableType0Void enter, TGS_CallableType0Void esc) {
        btn.addKeyDownHandler(e -> {
            if (e.isAnyModifierKeyDown()) {
                return;
            }
    ...
    public static void add(ListBox btn, TGS_CallableType0Void enter, TGS_CallableType0Void esc) {
        btn.addKeyDownHandler(e -> {
            if (e.isAnyModifierKeyDown()) {
                return;
            }
    ...
    public static void add(CheckBox btn, TGS_CallableType0Void enter, TGS_CallableType0Void esc) {
        btn.addKeyDownHandler(e -> {
    ...
    public static void add(RadioButton btn, TGS_CallableType0Void enter, TGS_CallableType0Void esc) {
        add((CheckBox) btn, enter, esc);
    }

    public static void add(TextArea btn, TGS_CallableType0Void controlEnter, TGS_CallableType0Void esc) {
        btn.addKeyDownHandler(e -> {
            var b = false;
            if (e.getNativeKeyCode() == KeyCodes.KEY_ESCAPE) {
                if (e.isAnyModifierKeyDown()) {
