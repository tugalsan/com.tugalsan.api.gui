...
//        TGC_DOMUtils.setVisible(dateBox.getDatePicker().getElement(), visible);//TODO CAUSES A GLASS PANEL ON LEFT TOP
    ...
    public TGC_PopLblYesNoDateBoxExtraBtn4Status(TGC_Dimension dim,
            ...
            TGS_Func_In1<TGC_PopLblYesNoDateBoxExtraBtn4Status> onExe,
            TGS_Func_In1<TGC_PopLblYesNoDateBoxExtraBtn4Status> onEsc,
            TGS_Func onVisible_optional, TGS_Func_OutTyped_In1<String, TGC_PopLblYesNoDateBoxExtraBtn4Status> statusModifier) {
        this(dim,
    ...
    final public TGS_Func_In1<TGC_PopLblYesNoDateBoxExtraBtn4Status> onEsc, onExe;
    final public TGS_Func onVisible;
    final private TGS_Func_OutTyped_In1<String, TGC_PopLblYesNoDateBoxExtraBtn4Status> statusModifier;
    ...
    final public void configLayout() {
        ...
        panelPopup = new TGC_Pop(
                TGC_PanelLayoutUtils.createDockNorth(6,
...
//        d.ci("btnAddHide", hide1, hide2);
    ...
    public void btnAddSet(
            TGS_Func_In1<TGC_PopLblYesNoDateBoxExtraBtn4Status> onAdd1,
            TGS_Func_In1<TGC_PopLblYesNoDateBoxExtraBtn4Status> onAdd2,
            TGS_Func_In1<TGC_PopLblYesNoDateBoxExtraBtn4Status> onAdd3,
            TGS_Func_In1<TGC_PopLblYesNoDateBoxExtraBtn4Status> onAdd4
    ) {
        this.onAdd1 = onAdd1;
        this.onAdd2 = onAdd2;
        this.onAdd3 = onAdd3;
    ...
    private TGS_Func_In1<TGC_PopLblYesNoDateBoxExtraBtn4Status> onAdd1, onAdd2, onAdd3, onAdd4;
}
