...
//    final private static TGC_Log d = TGC_Log.of(TGC_PopLblYesNoCheckListBox.class);
    ...
    final public void configFocus() {
        TGC_FocusUtils.addKeyDown(btnEsc, new TGS_FocusSides4(null, btnExe, null, tb));
        TGC_FocusUtils.addKeyDown(btnExe, new TGS_FocusSides4(btnEsc, null, null, btnSearch));
        TGC_FocusUtils.addKeyDown(tb, new TGS_FocusSides4(null, btnSearch, btnEsc, listBox));
        TGC_FocusUtils.addKeyDown(btnSearch, new TGS_FocusSides4(tb, null, btnExe, listBox));
        TGC_FocusUtils.addKeyDown(listBox, new TGS_FocusSides4(null, null, tb, null));
    }
